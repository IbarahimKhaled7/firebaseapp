...
import 'package:sdaw222/shered/Networkes/Logical/webview.dart';
...
Widget itemsgetdat(Model,context)=>InkWell(
  onTap: (){
...
Widget bluiteriemtdadt(list,{ isshow=true})=>list.length>0? ListView.separated(
  ...
  itemBuilder: (context, index) => itemsgetdat(list[index],context),
